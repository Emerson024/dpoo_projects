...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisQueRepresenta()
	{
		System.out.println("\n"+ "Pais al que representa un atleta"+ "\n");
		
		String nombre = input("Por favor ingrese el nombre de un atleta");
		
		String pais = calculadora.PaisQueRepresenta(nombre);
		System.out.println("El pais al cual representa el atleta " + nombre + " es " + pais);	
	}
